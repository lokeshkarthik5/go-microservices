...
const file_proto_inventory_proto_rawDesc = "" +
	...
	"\bin_stock\x18\x01 \x01(\bR\ainStock2S\n" +
	"\x10InventoryService\x12?\n" +
	"\n" +
	"CheckStock\x12\x17.inventory.StockRequest\x1a\x18.inventory.StockResponseB-Z+github.com/lokeshkarthik5/go-services/protob\x06proto3"
